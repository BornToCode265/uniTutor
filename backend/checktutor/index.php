...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if (!isset($_GET['expertise_name'])) {
        handleError("Expertise name is required");
    }
    ...
    try {
        ...
        $stmt = $pdo->prepare("SELECT expertise_id FROM expertise WHERE expertise_name = :expertise_name");
